        ...
        <SwiperSlide key={movie.id}>
          ...
          >
             {index === activeSlideIndex && (
              ...
              <div
                className="absolute inset-0 bg-gradient-to-r from-black-opq to-gray w-screen transition duration-75 ease-in-out "
              ></div>
            )}

            {index === activeSlideIndex && (
              <div key={movie.id} className='flex flex-col mb-4 z-20 drop-shadow-sm text-white w-2/6'>
