...
const Header = () => {
  return (
    <section className='bg-hero-pattern h-screen '>
      <div className='bg-gradient-to-r from-gray to-red-opacity-100-transparent h-screen px-28 flex-col items-center pt-28'>
